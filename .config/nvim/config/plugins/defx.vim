...
nnoremap <silent><M-b> :call <sid>defx_open()<CR>
...
function! s:defx_mappings() abort
  ...
  nnoremap <silent><buffer><expr> s defx#do_action('multi', [['drop', 'botright vsplit'], 'quit'])
  ...
  nnoremap <silent><buffer><expr> <M-b> defx#do_action('quit')
